...
class LargeuploadsApplicationTests {
	...
	public void shouldUploadFile() throws Exception {
		...
		ClassPathResource resource = new org.springframework.core.io.ClassPathResource("testupload.txt");
		//ClassPathResource resource = new MockMultipartFile("data", "filename.txt", "text/plain", "some xml".getBytes());
		...
		then(storageService).should().store_stream(any(InputStream.class),any(String.class));
	}
	...
	public void shouldDownloadFile() throws Exception {
		...
		assertThat(response.getBody()).isEqualTo("okok");
	}
